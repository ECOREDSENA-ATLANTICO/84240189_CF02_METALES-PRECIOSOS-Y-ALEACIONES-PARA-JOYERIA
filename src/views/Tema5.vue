  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.mb-5
      ...
      .col-lg-4.align-content-center
        figure
          img(src='@/assets/curso/temas/tema5/6.png', alt='Imagen de apoyo')
    .row.mb-5
      .col-lg-5
        figure
        ...
        LineaTiempoD.color-primario.mb-5
          ...
          div(numero="4" titulo="Fórmula para la densidad")
            ...
            figure.justify-content-center.d-flex.mb-3
              img.w-50(src='@/assets/curso/temas/tema5/14.svg', alt='Imagen de apoyo')
            ...
            .row.justify-content-center
              .col-lg-5
                div.tarjeta.bgr_10.p-4.text-white
          ...
          div(numero="6" titulo="Video")
            p Balanza analizar pureza del oro radwag <a href="https://www.youtube.com/watch?v=N-r5bACTxMk" target="_blank">ver video</a> 
            P Densidad por peso casero <a href="https://www.youtube.com/watch?v=ApPRH_EtjF0" target="_blank">ver video</a>
      .col-lg-4
        figure
    ...
    p.mt-4 La siguiente formula resulta muy útil cuando se quiere convertir una ley baja en otra alta, añadiendo oro fino. Se debe tener presente que 1000 milésimas corresponden a la ley del oro fino y que, en este caso, la ley deseada es siempre la ley más alta.

    figure.d-flex.justify-content-center.mb-5
      img.w-50(src='@/assets/curso/temas/tema5/15.svg', alt='Imagen de apoyo')
